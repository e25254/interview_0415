...
export const languageList: { [key: string]: string } = { "zh-TW": "繁體中文", en: "English", "zh-CN": "简体中文" };
...
export const routerArray: { id: number; path: string; name: string; element: FunctionComponent }[] = [
	{
		id: 1,
		path: "/home",
		name: "i18nDemo",
